...
class Config:
    ...
    MERCHANT_ACCOUNTS = {
        "kpay": os.getenv("PAY_KPAY", "09-7xx-xxx-xxx (Local Jaggery)"),
        "wavepay": os.getenv("PAY_WAVE", "09-7xx-xxx-xxx (Local Jaggery)"),
        "ayapay": os.getenv("PAY_AYA", "09-7xx-xxx-xxx (Local Jaggery)"),
        "cbpay": os.getenv("PAY_CB", "09-7xx-xxx-xxx (Local Jaggery)"),
        "yomapay": os.getenv("PAY_YOMA", "09-7xx-xxx-xxx (Local Jaggery)"),
        "bank": os.getenv("PAY_BANK", "AYA Bank — 1234 5678 9012 (Local Jaggery Co.)"),
    }
